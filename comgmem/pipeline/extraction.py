...
from comgmem.schema import MemoryExtraction, Message
from comgmem.utils.prompts import PromptRegistry
from comgmem.utils.text import truncate
...
class LLMMemoryExtractor:
    """One-pass extraction that leaves graph construction to ComGMem."""
